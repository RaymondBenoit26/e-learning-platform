...
ActiveRecord::Schema[8.0].define(version: 2025_06_22_123913) do
  ...
  create_table "course_assignments", force: :cascade do |t|
    ...
    t.index ["instructor_id"], name: "index_course_assignments_on_instructor_id"
  end
  ...
  create_table "license_accesses", force: :cascade do |t|
    ...
    t.index ["expires_at"], name: "index_license_accesses_on_expires_at"
    t.index ["license_id"], name: "index_license_accesses_on_license_id"
    t.index ["purchased_at"], name: "index_license_accesses_on_purchased_at"
    t.index ["student_id", "license_id"], name: "index_license_accesses_on_student_id_and_license_id", unique: true
    t.index ["student_id"], name: "index_license_accesses_on_student_id"
  end
  ...
  add_foreign_key "course_assignments", "users", column: "instructor_id"
